...
/**
 * Represents a State with the FSM.  Holds a map of events and {@link fsm.model.Transition}s.
 *
 *
...
public interface State<T> {
	...
	/**
	 * Add a {@link fsm.model.Transition}
	 *
	 * @param event The event to add the {@link fsm.model.Transition}
	 * @param transition The {@link fsm.model.Transition}
	 */
	 ...
	 * @param action The resulting {@link fsm.model.Action}
	 */

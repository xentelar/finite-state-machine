...
import fsm.utils.FieldAccessor;
import fsm.persistence.annotations.State;
...
/**
 * Encapsulates accessing the State Field.  It will inspect the {@link fsm.persistence.annotations.State}
